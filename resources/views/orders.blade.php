@extends('layouts.user_type.auth', ['parentFolder' => 'ecommerce', 'childFolder' => 'pedidos'])
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-2">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <p class="text-sm text-center font-weight-bold mt-2">Identificador / Número do Pedido
                                    </p>
                                </div>
                                <div class="col-4">
                            ...
                            @foreach ($allData['pedidos'] as $data)
                                <div class="row">
                                    <div class="col-4">
                                        <p class="text-sm text-center mt-2">{{ $data['id'] }} /
                                            {{ $data['numero_pedido'] }}</p>
                                    </div>
                                    <div class="col-4">
