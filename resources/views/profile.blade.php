                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                                ...
                                <ul class="list-group">
                                    ...
                                    <select class="form-control mb-3" name="store_id" id="store_id"
                                        ...
                                        @foreach ($fieldsSelect as $fSelect)
                                            ...
                                            <option @if ($fS['0'] == $user->store_id) selected="selected" @endif
                                                value="{{ $fS['0'] }}">{{ $fS['0'] }} - {{ ucfirst($fS['1']) }}
                                            </option>
                                        @endforeach
                                    </select>
                                </ul>
                            ...
                            <div class="mb-3">
                              ...
                              <input type="tel" class="form-control" id="phone" name="phone" pattern="[0-9]{10,11}" required placeholder="(xx) xxxxx-xxxx">
                          </div>
                            <div class="mb-3">
                                <label for="address" class="form-label">Endereço</label>
                                <input type="text" class="form-control" id="adress" name="adress" required placeholder="Insira o endereço aqui">
                            </div>
                            <div class="mb-3">
