                ...
                <div class="card-body p-3">
                    ...
                    <form method="GET" action="{{ route('requisicao-de-arte/storeform') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="varchar" class="form-control" id="url" name="url" placeholder="Insira o link de imagem aqui">
                        </div>
                        <div class="mb-3">
                            <p class="form-label">Precisa de data para a arte?</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="date_requisition_sim" name="precisa_data" value="sim">
                                <label class="form-check-label" for="date_requisition_sim">
                                    Sim
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="date_requisition_nao" name="precisa_data" value="nao" checked>
                        ...
                        <div class="mb-3" id="div-data" style="display: none;">
                            <label for="data" class="form-label">Data de entrega (Mínimo 2 dias úteis de produção)</label>
                        ...
                        <div class="mb-3">
                            <label for="obs " class="form-label">Precisa de dados de loja? Insira os dados necessários.</label>
